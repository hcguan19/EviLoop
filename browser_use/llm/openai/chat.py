...
def _strip_json_markdown_fence(content: str) -> str:
	"""Return raw JSON when OpenAI-compatible providers wrap it in markdown fences."""
	...
	async def ainvoke(
		...
		try:
			...
			if output_format is None:
				...
				parsed = output_format.model_validate_json(_strip_json_markdown_fence(choice.message.content))
